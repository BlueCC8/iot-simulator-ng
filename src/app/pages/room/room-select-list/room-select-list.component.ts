...
@Component({
  selector: 'app-select-room-list',
  templateUrl: './room-select-list.component.html',
  styleUrls: ['./room-select-list.component.css']
})
export class RoomSelectListComponent implements OnInit, OnDestroy {
  private componentName = RoomSelectListComponent.name + ' ';
